...
#     current_projects = models.ManyToManyField('Project', blank=True, related_name='current_users')
#     project_history = models.ManyToManyField('Project', blank=True, related_name='historical_users')
#
